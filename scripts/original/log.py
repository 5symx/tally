...
# Print result rounded to two decimals
print(f"Group naive's init_time is {increase_percent:.2f}% higher than Group mps's.")
...
# Print result rounded to two decimals
print(f"Group naive's init_time is {increase_percent:.2f}% higher than Group 2's.")
...
# Print result rounded to two decimals
print(f"Group mps's init_time is {increase_percent:.2f}% higher than Group 2's.")